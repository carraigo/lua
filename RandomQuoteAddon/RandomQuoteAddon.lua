local addonName = 'RandomQuoteAddon'
local addonTable = {}
...
local function PrintRandomQuote()
  local quoteIndex = math.random(1, #quotes)
  SendChatMessage(quotes[quoteIndex], "SAY")
end
...
frame:SetScript("OnEvent", function(self, event, ...)
  if event == "PLAYER_LOGIN" then
    print("Random Quote addon loaded, ya shits!")
    SLASH_RANDOMQUOTE1 = "/randomquote"
    SlashCmdList["RANDOMQUOTE"] = function()
      PrintRandomQuote()
    end
  end
end)
